...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, CreateTrimmableMod.MOD_ID, existingFileHelper);
    }
...
//        final String MOD_ID = BeautifulOpalMod.MOD_ID; // Change this to your mod id
        ...
        if(itemRegistryObject instanceof ArmorItem armorItem) {
            trimMaterials.entrySet().forEach(entry -> {
                ...
                String trimPath = "trims/items/card_" + armorType + "_trim_" + trimMaterial.location().getPath();
                String currentTrimName = armorItemPath.replaceFirst("item/", "item/create/") + "_" + trimMaterial.location().getPath() + "_trim";



                ResourceLocation armorItemResLoc = new ResourceLocation(Create.ID, armorItemPath);
                ResourceLocation trimResLoc = new ResourceLocation(Create.ID, trimPath); // minecraft namespace
...
//        final String MOD_ID = BeautifulOpalMod.MOD_ID; // Change this to your mod id
        ...
        if(itemRegistryObject instanceof ArmorItem armorItem) {
            trimMaterials.entrySet().forEach(entry -> {
                ...
                String armorItemPath = "item/" + armorItem;
                String trimPath = "trims/items/" + armorType + "_trim_" + trimMaterial.location().getPath();
                String currentTrimName = armorItemPath.replaceFirst("item/", "item/minecraft/") + "_" + trimMaterial.location().getPath() + "_trim";
